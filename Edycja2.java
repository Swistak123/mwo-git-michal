...
public class Edycja2 {
  ...
  public void edycja2() {
    ...
    driver.findElement(By.cssSelector("tr:nth-child(3) > td:nth-child(4)")).click();
    {
      WebElement element = driver.findElement(By.cssSelector("tr:nth-child(3) > td:nth-child(4)"));
    ...
    {
      WebElement element = driver.findElement(By.id("id_edit_button_1"));
    ...
    driver.findElement(By.id("id_first_name")).sendKeys("Ela");
    driver.findElement(By.cssSelector("input:nth-child(3)")).click();
